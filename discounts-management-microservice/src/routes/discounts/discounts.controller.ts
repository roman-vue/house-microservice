...
export class DiscountsController {
  ...
  public validateDiscount(
    @Payload() validateDiscountDTO: ValidateDiscountDTO,
  ...
  public registerDiscount(
    @Payload() registerDiscountDTO: RegisterDiscountDTO,
  ): Promise<IDiscount> {
  ...
  public deleteDiscount(
    @Payload() discountRegisterId: string,
